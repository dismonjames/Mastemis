...
public sealed class ProblemMetadataViewModel : ObservableObject
{
    ...
    public string Title { get => title; set { SetProperty(ref title, value); Dirty(); } } public string Authors { get => authors; set { SetProperty(ref authors, value); Dirty(); } }
    public string Tags { get => tags; set { SetProperty(ref tags, value); Dirty(); } } public string Difficulty { get => difficulty; set { SetProperty(ref difficulty, value); Dirty(); } }
    public string DefaultLocale { get => locale; set { SetProperty(ref locale, value); Dirty(); } } public string Languages { get => languages; set { SetProperty(ref languages, value); Dirty(); } }
    public string Checker { get => checker; set { SetProperty(ref checker, value); Dirty(); } } public long TimeLimit { get => time; set { SetProperty(ref time, value); Dirty(); } }
    public long MemoryLimit { get => memory; set { SetProperty(ref memory, value); Dirty(); } } public long OutputLimit { get => output; set { SetProperty(ref output, value); Dirty(); } }
