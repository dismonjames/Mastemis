...
public sealed class StatementAuthoringViewModel : ObservableObject
{
    ...
    public StatementSummary? Selected { get => selected; set => SetProperty(ref selected, value); }
    public string Locale { get => locale; set => SetProperty(ref locale, value); }
    public string Title { get => title; set => SetProperty(ref title, value); }
    public string Markdown { get => markdown; set => SetProperty(ref markdown, value); }
    public string InputDescription { get => input; set => SetProperty(ref input, value); }
    public string OutputDescription { get => output; set => SetProperty(ref output, value); }
    public string Constraints { get => constraints; set => SetProperty(ref constraints, value); }
