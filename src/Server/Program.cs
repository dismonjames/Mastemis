...
using Mastemis.Infrastructure.Persistence.Problems.Activity;
using Mastemis.Infrastructure.Persistence.Problems.Overview;
...
if (durableMode)
{
    ...
    builder.Services.AddScoped<IRoomQueryStore, PostgresRoomQueryStore>();
    ...
    builder.Services.AddScoped<IProblemLibraryQueryStore, PostgresProblemLibraryQueryStore>();
    builder.Services.AddScoped<ProblemLibraryQueryService>();
    ...
    builder.Services.AddScoped<IEvidenceActor, HttpEvidenceActor>();
    ...
    builder.Services.AddScoped<IProblemActivityStore, PostgresProblemActivityStore>();
    builder.Services.AddScoped<ProblemActivityService>();
    builder.Services.AddScoped<IProblemOverviewStore, PostgresProblemOverviewStore>();
    builder.Services.AddScoped<ProblemOverviewService>();
