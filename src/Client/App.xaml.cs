...
public sealed partial class App : Application
{
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        services.AddSingleton<IClientPage>(_ => new OperationalPage(ClientRoute.Rooms, "Rooms", "Room creation, room codes, invigilator assignments, and scoped room status are managed here."));
        services.AddSingleton<IClientPage>(_ => new OperationalPage(ClientRoute.Candidates, "Candidates", "Candidate registration, examination access state, sessions, warnings, and termination status are shown here."));
